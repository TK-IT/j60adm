...
urlpatterns = [
    ...
    url(r'^survey/email/$', NewsletterAddressList.as_view(),
        name='newsletter_address_list'),
    ...
    url(r'^registration/person/$', RegistrationPerson.as_view(),
        name='registration_person'),
